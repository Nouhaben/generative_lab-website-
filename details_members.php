                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
													echo"<td>".$enreg['full_name']."<b></td>";
													echo"<td>".$enreg['email']."<b></td>";
													echo"<td>".$enreg['phone']."<b></td>";
													echo"<td>".$enreg['profession']."<b></td>";
													echo"<td><a href='detai_cli.php?id=".$enreg[0]."' class=\"btn btn-rounded btn-success btn-block\"  >Consulter</a></td>"; 
												echo"</tr>";	
												}
										?>
