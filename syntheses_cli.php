            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-trail">Member informations</li>
                    </ol>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel bg-alert light of-h mb10">
                            <div class="pn pl20 p5">
								...
								<h5 class="text-muted">Total registered </h5>
                   ...
                   <!-- Column Graph -->
                           <div class="panel panel-info panel-border top">
                            <div class="panel-heading">
                                    <span class="panel-title fw700"> Member informations</span>
                                </div>
                                    ...
                                    <div class="row table-layout">
                                            ...
                                            <table class="table mbn tc-med-1 tc-bold-last">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-warning fs14 mr10"></span>Registered members today:</td>
                                                        <td><?php
													...
													if(isset($client_inscrits[date('Y-m-d')])){
													 ...
													 echo "No member is registered today."; 
													 }
													?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-info fs14 mr10"></span>Registered members this week :</td>
                                                        <td><?php
														$client_inscrits = array_count_values($enr['date_ajout']);
														 ...
														 if($nombretotal == 0 ) {
															echo "No member is registered this week.";
														 }else {
															echo $nombretotal;
														 }
														  ?></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span class="fa fa-circle text-primary fs14 mr10"></span>Registered members this month :</td>
                                                        <td><?php
													...
													if(isset($client_inscrits[date('Y-m')])){
													 ...
													 echo "No member is registered this month."; 
													 }
													?></td>
                                                    </tr>
